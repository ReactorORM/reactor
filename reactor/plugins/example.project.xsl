...
&lt;cfcomponent hint="I am the base Example object for the <xsl:value-of select="object/@alias"/> object.  I am generated.  DO NOT EDIT ME (but feel free to delete me)." &gt;
	...
	&lt;cffunction name="_configure" access="public" hint="I configure and return this object." output="false" returntype="any" _returntype="<xsl:value-of select="object/@alias"/>"&gt;
		&lt;cfreturn this /&gt;
	&lt;/cffunction&gt;
