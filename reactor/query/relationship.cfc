<cfcomponent hint="I am a relationship between two objects">
	...
	<cffunction name="init" access="public" hint="I represent a relationship between two fields" output="false" returntype="reactor.query.relationship">
		<cfargument name="fromField" hint="I am the from field" required="yes" type="string" />
		<cfargument name="toField" hint="I am the to field" required="yes" type="string" />
    ...
    <cffunction name="getFromField" access="package" output="false" returntype="string">
    ...
    <cffunction name="getToField" access="package" output="false" returntype="string">
