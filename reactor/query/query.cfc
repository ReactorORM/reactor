<cfcomponent hint="I am a component used to define ad-hoc queries used throughout Reactor.">
    ...
    <cffunction name="setObject" access="private" output="false" returntype="void">
       <cfargument name="object" hint="I am the base object being queried" required="yes" type="any" _type="reactor.query.object" />
       <cfset variables.instance.object = arguments.object />
    </cffunction>
    <cffunction name="getObject" access="private" output="false" returntype="any" _returntype="reactor.query.object">
    ...
    <cffunction name="setWhere" access="public" output="false" returntype="void">
		<cfargument name="where" hint="I am the query's where experssion" required="yes" type="any" _type="reactor.query.where" />
    ...
    <cffunction name="setOrder" access="public" output="false" returntype="void">
		<cfargument name="order" hint="I am the order expression" required="yes" type="any" _type="reactor.query.order" />
