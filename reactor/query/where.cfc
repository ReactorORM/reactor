<cfcomponent hint="I am an object used to create wheres for where statements">
	...
	<cffunction name="isBetween" access="public" hint="I return an where which checks if a field is between two other values." output="false" returntype="reactor.query.where">
		<cfargument name="objectAlias" hint="I am the alias of the object the field is in" required="yes" type="string" />
	...
	<cffunction name="isBetweenFields" access="public" hint="I return an where which checks if a field is between two other fields." output="false" returntype="reactor.query.where">
		<cfargument name="objectAlias" hint="I am the alias of the object the field is in" required="yes" type="string" />
		<cfargument name="fieldAlias" hint="I am the field to compare" required="yes" type="string" />
		<cfargument name="compareToObjectAlias1" hint="I am the alias of the object the first comparison field is in" required="yes" type="string" />
		<cfargument name="compareToFieldAlias1" hint="I am the first comparison field to compare" required="yes" type="string" />
		<cfargument name="compareToObjectAlias2" hint="I am the alias of the object the second comparison field is in" required="yes" type="string" />
		<cfargument name="compareToFieldAlias2" hint="I am the second comparison field to compare" required="yes" type="string" />
