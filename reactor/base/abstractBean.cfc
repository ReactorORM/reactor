<cfcomponent hint="I am an abstract form bean.  If you extend me to create a bean, you can then pass the extended form bean into any data bean to automatically populate it." extends="reactor.base.abstractObject">
