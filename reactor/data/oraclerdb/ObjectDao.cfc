...
--->
	...
	<cffunction name="getCfDataType" access="private" hint="I translate the Oracle rdb data type names into ColdFusion data type names" output="false" returntype="string">
		<cfargument name="typeName" hint="I am the type name to translate" required="yes" type="string" />
