<cfcomponent hint="I read Object data from a Postgresql database." extends="reactor.data.abstractObjectDao">
	...
	<cffunction name="getCfSqlType" access="private" hint="I translate the Postgresql data type names into ColdFusion cf_sql_xyz names" output="false" returntype="string">
