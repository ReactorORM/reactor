...
<cfset emailAddressQuery = ContactRecord.getEmailAddressIterator().getQuery() />
...
<cfset addressArray = ContactRecord.getAddressIterator().getArray() />
...
<!--- output this contact's associated phone numbers --->
<cfset phoneNumberQuery = ContactRecord.getPhoneNumberIterator().getQuery() />
