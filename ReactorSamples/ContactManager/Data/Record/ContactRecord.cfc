...
<cfcomponent hint="I am the database agnostic custom Record object for the Contact table.  I am generated, but not overwritten if I exist.  You are safe to edit me."
	extends="reactor.project.ContactManagerData.Record.ContactRecord" >
