...
ALTER TABLE [dbo].[Country] ADD 
	CONSTRAINT [DF_Country_sortFirst] DEFAULT (0) FOR [sortOrder],
...
ALTER TABLE [dbo].[Address] ADD 
	CONSTRAINT [FK_Address_Contact] FOREIGN KEY 
	(
		[contactId]
	...
	CONSTRAINT [FK_Address_State] FOREIGN KEY 
	(
		[stateId]
...
ALTER TABLE [dbo].[EmailAddress] ADD 
	CONSTRAINT [FK_EmailAddress_Contact] FOREIGN KEY 
	(
		[contactId]
	) REFERENCES [dbo].[Contact] (
		[contactId]
...
ALTER TABLE [dbo].[PhoneNumber] ADD 
	CONSTRAINT [FK_PhoneNumber_Contact] FOREIGN KEY 
	(
		[contactId]
	) REFERENCES [dbo].[Contact] (
		[contactId]
