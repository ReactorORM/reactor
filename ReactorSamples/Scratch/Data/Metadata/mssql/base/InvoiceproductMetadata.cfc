...
<cfcomponent hint="I am the base Metadata object for the InvoiceProduct table.  I am generated.  DO NOT EDIT ME."
	extends="reactor.base.abstractMetadata" >
	
	<cfset variables.signature = "CAF9ECE5C44292D7A17CAC3CD9E18371" >
	
	<cfset variables.metadata.name = "InvoiceProduct" />
	...
	<cfset variables.metadata.hasOne = ArrayNew(1) />
		...
		<cfset variables.metadata.hasOne[1].name = "Invoice" />
		<cfset variables.metadata.hasOne[1].alias = "Invoice" />
		<cfset variables.metadata.hasOne[1].relate = ArrayNew(1) />
		
		
			<cfset variables.metadata.hasOne[1].relate[1] = StructNew() />
			<cfset variables.metadata.hasOne[1].relate[1].from = "invoiceId" />
			<cfset variables.metadata.hasOne[1].relate[1].to = "invoiceId" />
		
		<cfset variables.metadata.hasOne[2] = StructNew() />
		<cfset variables.metadata.hasOne[2].name = "Product" />
		<cfset variables.metadata.hasOne[2].alias = "Product" />
		<cfset variables.metadata.hasOne[2].relate = ArrayNew(1) />
		
		
			<cfset variables.metadata.hasOne[2].relate[1] = StructNew() />
			<cfset variables.metadata.hasOne[2].relate[1].from = "productId" />
			<cfset variables.metadata.hasOne[2].relate[1].to = "productId" />
	...
	<cfset variables.metadata.fields = ArrayNew(1) />
		...
		<cfset variables.metadata.fields[1]["name"] = "InvoiceProductId" />
		...
		<cfset variables.metadata.fields[1]["object"] = "InvoiceProduct" />
	
		<cfset variables.metadata.fields[2] = StructNew() />
		<cfset variables.metadata.fields[2]["name"] = "InvoiceId" />
		...
		<cfset variables.metadata.fields[2]["object"] = "InvoiceProduct" />
	
		<cfset variables.metadata.fields[3] = StructNew() />
		<cfset variables.metadata.fields[3]["name"] = "ProductId" />
		...
		<cfset variables.metadata.fields[3]["object"] = "InvoiceProduct" />
