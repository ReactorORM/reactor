...
<cfcomponent hint="I am the base DAO object for the Comment table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="save" access="public" hint="I create or update a Comment record." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Comment" required="yes" type="ReactorBlogData.To.mysql.CommentTo" />
	...
	<cffunction name="read" access="public" hint="I read a  Comment object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Comment which will be populated." required="yes" type="ReactorBlogData.To.mysql.CommentTo" />
		<cfset var qRead = 0 />
	...
	<cffunction name="update" access="public" hint="I update a Comment object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Comment which will be used to update a record in the table." required="yes" type="ReactorBlogData.To.mysql.CommentTo" />
		<cfset var Convention = getConventions() />
		<cfset var qUpdate = 0 />
	...
	<cffunction name="delete" access="public" hint="I delete a record in the Comment table." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Comment which will be used to delete from the table." required="yes" type="ReactorBlogData.To.mysql.CommentTo" />
		<cfset var Convention = getConventions() />
		<cfset var qDelete = 0 />
