...
<cfcomponent hint="I am the base DAO object for the Rating table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="save" access="public" hint="I create or update a Rating record." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Rating" required="yes" type="ReactorBlogData.To.mysql.RatingTo" />
	...
	<cffunction name="read" access="public" hint="I read a  Rating object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Rating which will be populated." required="yes" type="ReactorBlogData.To.mysql.RatingTo" />
		<cfset var qRead = 0 />
	...
	<cffunction name="update" access="public" hint="I update a Rating object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Rating which will be used to update a record in the table." required="yes" type="ReactorBlogData.To.mysql.RatingTo" />
		<cfset var Convention = getConventions() />
		<cfset var qUpdate = 0 />
	...
	<cffunction name="delete" access="public" hint="I delete a record in the Rating table." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Rating which will be used to delete from the table." required="yes" type="ReactorBlogData.To.mysql.RatingTo" />
		<cfset var Convention = getConventions() />
		<cfset var qDelete = 0 />
