...
<cfcomponent hint="I am the base DAO object for the Category table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="save" access="public" hint="I create or update a Category record." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Category" required="yes" type="ReactorBlogData.To.mssql.CategoryTo" />
	...
	<cffunction name="read" access="public" hint="I read a  Category object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Category which will be populated." required="yes" type="ReactorBlogData.To.mssql.CategoryTo" />
		<cfset var qRead = 0 />
	...
	<cffunction name="update" access="public" hint="I update a Category object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Category which will be used to update a record in the table." required="yes" type="ReactorBlogData.To.mssql.CategoryTo" />
		<cfset var Convention = getConventions() />
		<cfset var qUpdate = 0 />
	...
	<cffunction name="delete" access="public" hint="I delete a record in the Category table." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for Category which will be used to delete from the table." required="yes" type="ReactorBlogData.To.mssql.CategoryTo" />
		<cfset var Convention = getConventions() />
		<cfset var qDelete = 0 />
