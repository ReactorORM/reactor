...
<cfcomponent hint="I am the base DAO object for the EntryCategory table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="save" access="public" hint="I create or update a EntryCategory record." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for EntryCategory" required="yes" type="ReactorBlogData.To.mssql.EntryCategoryTo" />
	...
	<cffunction name="read" access="public" hint="I read a  EntryCategory object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for EntryCategory which will be populated." required="yes" type="ReactorBlogData.To.mssql.EntryCategoryTo" />
		<cfset var qRead = 0 />
	...
	<cffunction name="update" access="public" hint="I update a EntryCategory object." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for EntryCategory which will be used to update a record in the table." required="yes" type="ReactorBlogData.To.mssql.EntryCategoryTo" />
		<cfset var Convention = getConventions() />
		<cfset var qUpdate = 0 />
	...
	<cffunction name="delete" access="public" hint="I delete a record in the EntryCategory table." output="false" returntype="void">
		<cfargument name="to" hint="I am the transfer object for EntryCategory which will be used to delete from the table." required="yes" type="ReactorBlogData.To.mssql.EntryCategoryTo" />
		<cfset var Convention = getConventions() />
		<cfset var qDelete = 0 />
