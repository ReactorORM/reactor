...
<cfcomponent hint="I am the base record representing the Entry table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="init" access="public" hint="I configure and return this record object." output="false" returntype="ReactorBlogData.Record.mysql.base.EntryRecord">
			...
			<cfargument name="PublicationDate" hint="I am the default value for the  PublicationDate field." required="no" type="string" default="" />
			...
			<cfargument name="DisableComments" hint="I am the default value for the  DisableComments field." required="no" type="string" default="0" />
	...
	<cffunction name="validate" access="public" hint="I validate this object and populate and return a ValidationErrorCollection object." output="false" returntype="reactor.util.ValidationErrorCollection">
		...
		<cfset var ErrorManager = CreateObject("Component", "reactor.core.ErrorManager").init(expandPath("#_getConfig().getMapping()#/ErrorMessages.xml")) />
					...
					<cfif Len(getArticle()) GT 4294967295 >
					...
					<!--- validate DisableComments is numeric --->
					<cfif Len(Trim(getDisableComments())) AND NOT IsNumeric(getDisableComments())>
	...
	<cffunction name="setAuthorRecord" access="public" output="false" returntype="void">
	    <cfargument name="Record" hint="I am the Record to set the Author value from." required="yes" type="ReactorBlogData.Record.mysql.UserRecord" />
		
			<cfset setpostedByUserId(Record.getuserId()) />
		
	</cffunction>
	<cffunction name="getAuthorRecord" access="public" output="false" returntype="ReactorBlogData.Record.mysql.UserRecord">
	...
	<cffunction name="_setTo" access="public" output="false" returntype="void">
	    <cfargument name="to" hint="I am this record's transfer object." required="yes" type="ReactorBlogData.To.mysql.EntryTo" />
	    <cfset variables.to = arguments.to />
	</cffunction>
	<cffunction name="_getTo" access="public" output="false" returntype="ReactorBlogData.To.mysql.EntryTo">
		<cfreturn variables.to />
	</cffunction>	
	
	<!--- dao --->
	<cffunction name="_setDao" access="private" output="false" returntype="void">
	    <cfargument name="dao" hint="I am the Dao this Record uses to load and save itself." required="yes" type="ReactorBlogData.Dao.mysql.EntryDao" />
	    <cfset variables.dao = arguments.dao />
	</cffunction>
	<cffunction name="_getDao" access="private" output="false" returntype="ReactorBlogData.Dao.mysql.EntryDao">
