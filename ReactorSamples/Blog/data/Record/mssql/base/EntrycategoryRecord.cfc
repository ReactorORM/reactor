...
<cfcomponent hint="I am the base record representing the EntryCategory table.  I am generated.  DO NOT EDIT ME."
	...
	<cffunction name="init" access="public" hint="I configure and return this record object." output="false" returntype="ReactorBlogData.Record.mssql.base.EntryCategoryRecord">
	...
	<cffunction name="setEntryRecord" access="public" output="false" returntype="void">
	    <cfargument name="Record" hint="I am the Record to set the Entry value from." required="yes" type="ReactorBlogData.Record.mssql.EntryRecord" />
		
			<cfset setentryId(Record.getentryId()) />
		
	</cffunction>
	<cffunction name="getEntryRecord" access="public" output="false" returntype="ReactorBlogData.Record.mssql.EntryRecord">
	...
	<cffunction name="setCategoryRecord" access="public" output="false" returntype="void">
	    <cfargument name="Record" hint="I am the Record to set the Category value from." required="yes" type="ReactorBlogData.Record.mssql.CategoryRecord" />
		
			<cfset setcategoryId(Record.getcategoryId()) />
		
	</cffunction>
	<cffunction name="getCategoryRecord" access="public" output="false" returntype="ReactorBlogData.Record.mssql.CategoryRecord">
	...
	<cffunction name="_setTo" access="public" output="false" returntype="void">
	    <cfargument name="to" hint="I am this record's transfer object." required="yes" type="ReactorBlogData.To.mssql.EntryCategoryTo" />
	    <cfset variables.to = arguments.to />
	</cffunction>
	<cffunction name="_getTo" access="public" output="false" returntype="ReactorBlogData.To.mssql.EntryCategoryTo">
		<cfreturn variables.to />
	</cffunction>	
	
	<!--- dao --->
	<cffunction name="_setDao" access="private" output="false" returntype="void">
	    <cfargument name="dao" hint="I am the Dao this Record uses to load and save itself." required="yes" type="ReactorBlogData.Dao.mssql.EntryCategoryDao" />
	    <cfset variables.dao = arguments.dao />
	</cffunction>
	<cffunction name="_getDao" access="private" output="false" returntype="ReactorBlogData.Dao.mssql.EntryCategoryDao">
