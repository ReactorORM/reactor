...
<cfcomponent hint="I am the database agnostic custom Gateway object for the EntryCategory table.  I am generated, but not overwritten if I exist.  You are safe to edit me."
	extends="reactor.project.ReactorBlog.Gateway.EntryCategoryGateway" >
