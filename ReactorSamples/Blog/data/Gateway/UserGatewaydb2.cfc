...
<cfcomponent hint="I am the db2 custom Gateway object for the User object.  I am generated, but not overwritten if I exist.  You are safe to edit me."
	extends="UserGateway" >
	...
	<cffunction name="getAllUsers" access="public" hint="I return a query of users and the number of entries they've created" output="false" returntype="query">
		...
		<cfquery name="users" datasource="#_getConfig().getDsn()#">
			...
			FROM "NULLID"."User" as u LEFT JOIN "NULLID"."Entry" as e
